...
`;
        ...
        if (args && typeof args.code === 'string') {
            ...
            if (imports.size > 0) {
                ...
                try {
                    ...
                    missingDependencies = Array.from(imports).filter(imp => !installedNames.some(pkg => pkg === imp.toLowerCase()));
    ...
    async withVenvLock(operation) {
        ...
        let releaseLock;
        this.venvLockPromise = new Promise(resolve => {
            releaseLock = resolve;
        });
