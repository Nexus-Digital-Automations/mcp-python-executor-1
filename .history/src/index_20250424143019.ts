      ...
      try {
        ...
        try {
          if (isWindows) {
            ...
            const { stdout: procStdout, stderr: procStderr } = await this.venvManager.execCommand(command, execOptions);
            stdout = procStdout;
            stderr = procStderr;
          } else {
            // On Unix, we can use the pythonExecutable path directly
            ...
            const { stdout: procStdout, stderr: procStderr } = await this.venvManager.execCommand(
